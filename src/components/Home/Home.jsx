...
function Home({name}) {
  ...
  useEffect(() => {
    ...
    // You can replace 'username' with the actual username once you have access to it
  ...
  const phrase = "Improving agriculture, improving lives";
  const typingSpeed = 35; // Speed of typing in milliseconds
  ...
  return (
   <div>  
    ...
    <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
      <h1 className='md:text-3xl sm:text-8  xl text-[#000] font-bold md:py-6'>Welcome {name}, {greetingMessage}</h1> 
        <h1 className='md:text-8xl sm:text-6xl text-[#000] font-bold md:py-6'>
         The Right choice for your farm
        </h1>
        <div className='flex justify-center items-center'>
      <p className='md:text-5xl sm:text-4xl text-[#000] text-green-800  font-bold py-4 transition duration-500 ease-in-out hover:text-green-600 font-bold py-4'>{text}</p>
    </div>
      <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black'><a href="/Predict">Click here to Start  </a></button>
      </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <p>
          Empowering farmers with data-driven insights, our crop yield prediction and crop recommendation platform revolutionizes agricultural practices.
           Leveraging advanced algorithms and machine learning, we analyze various factors including soil quality, weather patterns, and historical data to accurately forecast crop yields. 
           Our tailored recommendations help farmers optimize their planting strategies, leading to improved productivity and sustainable farming practices. 
          </p>
...
<div className="relative max-w-6xl mx-auto px-4 sm:px-6">
  <div className="py-12 md:py-20">
    ...
    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
      <h2 className="h2 mb-4">How AgriForecast works</h2>
    </div>
    ...
    <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Login/Signup</h4>
        <p className="text-gray-600 text-center">Create your account in our application to save preferences.</p>
      </div>
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Discover Dashboard</h4>
        <p className="text-gray-600 text-center">Discover the our dashboard through the links and buttons provided.</p>
      </div>
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><a href="/WeatherForecast">Weather Forecast</a></h4>
        <p className="text-gray-600 text-center">If you are keen to know the weather forecast here is the good news.</p>
      </div>
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><a href="/NewsPage">Agricultural articles</a></h4>
        <p className="text-gray-600 text-center">Find the latest news regarding the agriculutral sector</p>
      </div>
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><a href='/Predict'>Yield Predictor</a></h4>
        <p className="text-gray-600 text-center">Predict the crop production yield for a particular crop </p>
      </div>
      ...
      <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
        ...
        <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><a href='/CropRecommend'>Crop Recommend</a></h4>
        <p className="text-gray-600 text-center">Use our recommend system to know what crops to grow in your farm</p>
      </div>
...
<div className="max-w-6xl mx-auto px-4 sm:px-6">
  <div className="py-12 md:py-20">
    ...
    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
      <h2 className="h2 mb-4">Trusted all over the world</h2>
      <p className="text-xl text-gray-600" data-aos="zoom-y-out"> Our agricultural services is been used by major world leading companies  </p>
    </div>
    ...
    <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
      ...
      <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
        <svg className="max-w-full fill-current text-gray-400" width="83" height="30" viewBox="0 0 83 30" xmlns="http://www.w3.org/2000/svg">
          <path fill="black" d="M 10 40 v -30 h 15 q 10 0 10 5 v 5 q 0 5 -10 5 h -5 v 15 h 5 q 10 0 10 5 v 5 q 0 5 -10 5 h -15 Z"/>
          <path fill="black" d="M 40 30 a 10 10 0 1 1 20 0 a 10 10 0 1 1 -20 0 Z"/>
           <path fill="black" d="M 70 30 a 10 10 0 1 1 20 0 a 10 10 0 1 1 -20 0 Z"/>
            <path fill="black" d="M 100 35 h 15 v -5 q 0 -5 -5 -5 q -5 0 -5 5 q 0 5 5 5 q 5 0 5 5 v 5 h -10 q -5 0 -5 -5 q 0 -2 1 -3 q 2 -2 5 -2 q 5 0 5 5 q 0 4 -5 4 h -5 v 5 Z"/>
           <path fill="black" d="M 130 40 v -30 h 5 v 30 Z"/>
           <path fill="black" d="M 140 30 h 15 v -5 q 0 -5 -5 -5 h -5 v -10 h 5 q 5 0 5 -5 q 0 -2 -1 -3 q -2 -2 -5 -2 q -5 0 -5 5 v 5 h 5 q 5 0 5 5 q 0 5 -5 5 h -10 v 5 Z"/>
      ...
      <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
        ...
        <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
          <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
            ...
            <img className="relative rounded-full" src={logo} width="96" height="96" alt="Testimonial 01" />
          </div>
          <blockquote className="text-xl font-medium mb-4">
            “ I love this product and would recommend it to anyone. Could be not easier to use, and their prediction service is accurate enough. “
          </blockquote>
          <cite className="block font-bold text-lg not-italic mb-1">XYZ </cite>
          <div className="text-gray-600">
            <span>CEO & Co-Founder</span> <a className="text-blue-600 hover:underline" href="#0">@DummySoftwareCompany</a>
          </div>
        </div>
